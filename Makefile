...
# quay.io/kube-fieldforge/kube-fieldforge-bundle:$VERSION and quay.io/kube-fieldforge/kube-fieldforge-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/kube-fieldforge/kube-fieldforge
